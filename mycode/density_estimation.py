...
# }
models = {
    "SB-CFM (ours)": torch.load(f"{savedir}/cfm_v1.pt", weights_only=False),
}
...
for name, model in models.items():
    ...
    for ii, name in enumerate(names):
        ...
        nde = NeuralODE(cnf, solver="dopri5", sensitivity="adjoint")
    ...
    plt.savefig(f"figures/trajectory/v3/test.png", dpi=40)
    plt.close()