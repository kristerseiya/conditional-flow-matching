...
class SuperResModel(UNetModel):
    ...
    def forward(self, t, x, low_res=None, **kwargs):
        _, _, new_height, new_width = x.shape
        upsampled = F.interpolate(low_res, (new_height, new_width), mode="bilinear")
        x = th.cat([x, upsampled], dim=1)
        return super().forward(t, x, **kwargs)
...
class SuperResModelWrapper(SuperResModel):
    def __init__(
        self,
        dim,
        num_channels,
    ...
    def forward(self, t, x, y=None, low_res=None, *args, **kwargs):
        return super().forward(t, x, y=y, low_res=low_res)